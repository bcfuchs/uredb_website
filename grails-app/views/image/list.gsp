			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="resource_id" title="${message(code: 'image.resource_id.label', default: 'Resourceid')}" />
				...
				<g:each in="${imageInstanceList}" status="i" var="imageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${imageInstance.id}">${fieldValue(bean: imageInstance, field: "resource_id")}</g:link></td>
