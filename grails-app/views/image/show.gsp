	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<ol class="property-list image">
				...
				<g:if test="${imageInstance?.resource_id}">
				<li class="fieldcontain">
					<span id="resource_id-label" class="property-label"><g:message code="image.resource_id.label" default="Resourceid" /></span>
					
						<span class="property-value" aria-labelledby="resource_id-label"><g:fieldValue bean="${imageInstance}" field="resource_id"/></span>
