...
<script>
var thumb_image_map_url = "${resource(dir:'html',file:'thumb_image_map.html  ')}"
</script>
<script src="${resource(dir:'js',file:'search_page.js')}"></script>
<link rel="stylesheet" href="${resource(dir:'css/ure',file:'search_page.css')}" />
</head>
<body>
