					...
					<div id="comparanda" class="left_nav1" data-placement="top" data-toggle="tooltip"
						...
						<div class="left_nav2 lighttable-controls2">
							<span id="view-comps" data-toggle="tooltip" title="view comparanda page" class="ure-control-btn glyphicon glyphicon-eye-open"></span>
							...
							<span id="save-comps-as-json" data-toggle="tooltip" title="download" class="ure-control-btn glyphicon glyphicon-download-alt"></span>
					...
					<div id="lighttable-links" class="left_nav1" data-placement="top" data-toggle="tooltip"
						...
						<div class="left_nav2 lighttable-controls2">
							...
							<span id="clear-lighttable" data-toggle="tooltip" title="clear"
								class="ure-control-btn glyphicon glyphicon-remove-circle"></span>
							<span id="load-lighttable" data-toggle="tooltip" title="load" class="ure-control-btn glyphicon glyphicon-upload"></span>
							<span id="save-lighttable" data-toggle="tooltip" title="download"
